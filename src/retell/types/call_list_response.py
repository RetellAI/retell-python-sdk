...
__all__ = [
    "CallListResponse",
    "CallListResponseItem",
    "CallListResponseItemE2eLatency",
    "CallListResponseItemTranscriptObject",
    "CallListResponseItemTranscriptObjectWord",
]


class CallListResponseItemE2eLatency(BaseModel):
...
class CallListResponseItemTranscriptObjectWord(BaseModel):
...
class CallListResponseItemTranscriptObject(BaseModel):
    content: str
    ...
    words: List[CallListResponseItemTranscriptObjectWord]
...
class CallListResponseItem(BaseModel):
    ...
    e2e_latency: Optional[CallListResponseItemE2eLatency] = None
    """
    ...
    transcript_object: Optional[List[CallListResponseItemTranscriptObject]] = None
