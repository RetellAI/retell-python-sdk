...
class CallResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return cast(
            CallResponse,
            self._get(
                path_template("/v2/get-call/{call_id}", call_id=call_id),
    ...
    def update(
        ...
        *,
        ...
        return cast(
            CallResponse,
            self._patch(
                path_template("/v2/update-call/{call_id}", call_id=call_id),
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            path_template("/v2/delete-call/{call_id}", call_id=call_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    def stop(
        ...
        *,
        ...
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            path_template("/v2/stop-call/{call_id}", call_id=call_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
