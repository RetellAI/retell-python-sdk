...
from ._exceptions import ToddlztError, APIStatusError
...
class Toddlzt(SyncAPIClient):
    calls: resources.Calls
    agents: resources.Agents
    with_raw_response: ToddlztWithRawResponse
    with_streaming_response: ToddlztWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous toddlzt client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("TODDLZT_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = ToddlztWithRawResponse(self)
        self.with_streaming_response = ToddlztWithStreamedResponse(self)
...
class AsyncToddlzt(AsyncAPIClient):
    calls: resources.AsyncCalls
    agents: resources.AsyncAgents
    with_raw_response: AsyncToddlztWithRawResponse
    with_streaming_response: AsyncToddlztWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async toddlzt client instance.
        ...
        self.with_raw_response = AsyncToddlztWithRawResponse(self)
        self.with_streaming_response = AsyncToddlztWithStreamedResponse(self)
...
class AsyncToddlztWithRawResponse:
...
class ToddlztWithStreamedResponse:
    def __init__(self, client: Toddlzt) -> None:
...
class AsyncToddlztWithStreamedResponse:
    def __init__(self, client: AsyncToddlzt) -> None:
