...
from retell_ai.types import CallBase, CallListResponse
...
class TestCalls:
    ...
    @parametrize
    def test_method_list_with_all_params(self, client: RetellAI) -> None:
        call = client.calls.list(
            filter_criteria={
    ...
    @parametrize
    def test_method_register(self, client: RetellAI) -> None:
    ...
    @parametrize
    def test_method_register_with_all_params(self, client: RetellAI) -> None:
        call = client.calls.register(
            agent_id="oBeDLoLOeuAbiuaMFXRtDOLriTJ5tSxD",
            audio_encoding="s16le",
            audio_websocket_protocol="twilio",
    ...
    @parametrize
    def test_raw_response_register(self, client: RetellAI) -> None:
    ...
    @parametrize
    def test_streaming_response_register(self, client: RetellAI) -> None:
...
class TestAsyncCalls:
    ...
    @parametrize
    async def test_method_list_with_all_params(self, async_client: AsyncRetellAI) -> None:
        call = await async_client.calls.list(
            filter_criteria={
                "agent_id": ["oBeDLoLOeuAbiuaMFXRtDOLriTJ5tSxD"],
                "before_start_timestamp": 1703302407399,
    ...
    @parametrize
    async def test_method_register(self, async_client: AsyncRetellAI) -> None:
    ...
    @parametrize
    async def test_method_register_with_all_params(self, async_client: AsyncRetellAI) -> None:
        call = await async_client.calls.register(
            agent_id="oBeDLoLOeuAbiuaMFXRtDOLriTJ5tSxD",
            audio_encoding="s16le",
            audio_websocket_protocol="twilio",
    ...
    @parametrize
    async def test_raw_response_register(self, async_client: AsyncRetellAI) -> None:
    ...
    @parametrize
    async def test_streaming_response_register(self, async_client: AsyncRetellAI) -> None:
