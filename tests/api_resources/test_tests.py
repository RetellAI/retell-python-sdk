...
class TestTests:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_test_runs_with_all_params(self, client: Retell) -> None:
        test = client.tests.list_test_runs(
            test_case_batch_job_id="test_case_batch_job_id",
            limit=1000,
            pagination_key="pagination_key",
...
class TestAsyncTests:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_test_runs_with_all_params(self, async_client: AsyncRetell) -> None:
        test = await async_client.tests.list_test_runs(
            test_case_batch_job_id="test_case_batch_job_id",
            limit=1000,
            pagination_key="pagination_key",
