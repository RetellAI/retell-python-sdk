...
```python
from retell.types import RegisterCallResponse, CallRetrieveResponse, CallListResponse
```
...
- <code title="get /get-call/{call_id}">client.call.<a href="./src/retell/resources/call.py">retrieve</a>(call_id) -> <a href="./src/retell/types/call_retrieve_response.py">CallRetrieveResponse</a></code>
