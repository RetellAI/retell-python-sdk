...
```python
from retell.types import RegisterCallResponse, RegisterCallResponse, CallListResponse
```
...
- <code title="get /get-call/{call_id}">client.call.<a href="./src/retell/resources/call.py">retrieve</a>(call_id) -> <a href="./src/retell/types/register_call_response.py">RegisterCallResponse</a></code>
